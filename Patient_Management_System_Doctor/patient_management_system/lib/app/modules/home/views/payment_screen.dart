        ...
        builder: (ctx) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              Text('Opening Balance: ₹${pay.openingBalance.toStringAsFixed(2)}'),
              Text('Current Payment: ₹${pay.currentPayment.toStringAsFixed(2)}'),
              Text('Paid Today: ₹${pay.amountPayingToday.toStringAsFixed(2)}'),
              const Divider(),
              Text('Remaining: ₹${pay.remainingBalance.toStringAsFixed(2)}', style: const TextStyle(fontWeight: FontWeight.bold)),
            ],
          ),
          actions: [
                          ...
                          _sectionCard(
                            child: Column(
                              ...
                              children: [
                                ...
                                _rowText('Patient ID', _patientId.isEmpty ? '—' : _patientId),
                          ...
                          _sectionCard(
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 12),
                                _rowText('Remaining Balance', '₹${pay.remainingBalance.toStringAsFixed(2)}', isBold: true),
                                const SizedBox(height: 8),
                                SizedBox(
